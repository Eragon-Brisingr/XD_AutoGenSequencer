 ...
 */
USTRUCT()
struct AUTOGENSEQUENCER_EDITOR_API FDialogueCharacterData
{
	GENERATED_BODY()
public:
...
// 生成期间的角色数据信息
struct AUTOGENSEQUENCER_EDITOR_API FGenDialogueCharacterData : public FDialogueCharacterData
{
...
UCLASS(abstract)
class AUTOGENSEQUENCER_EDITOR_API UGenDialogueSequenceConfigBase : public UObject
{
	GENERATED_BODY()
public:
