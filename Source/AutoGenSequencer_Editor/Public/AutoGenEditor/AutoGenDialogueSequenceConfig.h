...
class AUTOGENSEQUENCER_EDITOR_API UAutoGenDialogueSequenceConfig : public UGenDialogueSequenceConfigBase
{
	GENERATED_BODY()
public:
...
public:
	...
	struct AUTOGENSEQUENCER_EDITOR_API FGenDialogueData
	{
...
protected:
	...
	struct AUTOGENSEQUENCER_EDITOR_API FAnimTrackData
	{
		struct AUTOGENSEQUENCER_EDITOR_API FAnimSectionVirtualData
		{
