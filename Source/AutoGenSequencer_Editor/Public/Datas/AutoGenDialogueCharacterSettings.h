 ...
 */
UCLASS()
class AUTOGENSEQUENCER_EDITOR_API UAutoGenDialogueCharacterSettings : public UObject
{
	GENERATED_BODY()
public:
...
UCLASS()
class AUTOGENSEQUENCER_EDITOR_API UAutoGenDialogueCharacterSettingsFactory : public UFactory
{
	GENERATED_BODY()
public:
