 ...
 */
UCLASS(abstract)
class AUTOGENSEQUENCER_EDITOR_API UAutoGenDialogueAnimSetBase : public UObject
{
	GENERATED_BODY()
public:
...
class AUTOGENSEQUENCER_EDITOR_API UAutoGenDialogueAnimSet : public UAutoGenDialogueAnimSetBase
{
	GENERATED_BODY()
public:
...
UCLASS()
class AUTOGENSEQUENCER_EDITOR_API UAutoGenDialogueAnimSetFactory : public UFactory
{
	GENERATED_BODY()
public:
