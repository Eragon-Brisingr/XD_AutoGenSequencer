 ...
 * 
 */
class AUTOGENSEQUENCER_EDITOR_API FDialogueSentenceTrackEditor : public FMovieSceneTrackEditor
{
public:
...
class AUTOGENSEQUENCER_EDITOR_API FDialogueSentenceSectionEditor
