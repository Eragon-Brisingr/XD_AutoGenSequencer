 ...
 */
UCLASS()
class AUTOGENSEQUENCER_API UDialogueSentenceTrack : public UMovieSceneNameableTrack
{
	GENERATED_BODY()
public:
...
#endif
public:
	UDialogueSentenceSection* AddNewSentenceOnRow(UDialogueSentence* DialogueSentence, FFrameNumber Time, int32 RowIndex = INDEX_NONE);
};
